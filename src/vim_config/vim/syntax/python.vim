...
if exists("python_highlight_builtin_funcs") && python_highlight_builtin_funcs != 0
  ...
  syn keyword pythonBuiltinFunc	type unichr unicode vars xrange zip
	"wxpythoon key world
	syn keyword pythonBuiltinFunc PySimpleApp FontDialog ShowModal GetChosenFont GetColour
	syn keyword pythonBuiltinFunc GetFaceName GetPointSize GetFontData ColourDialog
	syn keyword pythonBuiltinFunc GridSizer FindWindowByName SetMinSize SetSizer Fit
	syn keyword pythonBuiltinFunc Show MainLoop Add get __init__
