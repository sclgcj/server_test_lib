...
#include "jc_type_file_seq_abort_private.h"

#define JC_TYPE_FILE_SEQ_ABORT "sequence_in_a_abort" 
...
json_type_file_seq_abort_uninit()
{
	...
	return jc_type_file_seq_module_add(JC_TYPE_FILE_SEQ_ABORT, &oper);
}
